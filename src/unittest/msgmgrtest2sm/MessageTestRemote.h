...
* Description: Unit test code for the MsgMgr framework. Local Shared Memory
*              Mailbox tests.
* 
* Name                 Date       Release 
* -------------------- ---------- ---------------------------------------------
 ...
 * This class deals exclusively with Local Shared Memory Mailboxes.
 * <p>
...
class MessageTestRemote
{
   ...
   private:
       ...
       * to setup handlers.
       * @param localAddress Mailbox Address of the MessageTestRemote LocalSMMailbox
      ...
      MailboxOwnerHandle* messageTestSMMailbox_;
