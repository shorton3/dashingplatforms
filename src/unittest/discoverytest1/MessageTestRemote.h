...
* Description: Unit test code for the MsgMgr framework. Distributed Mailbox 
*              testing the Discovery functionality.
* 
* Name                 Date       Release 
* -------------------- ---------- ---------------------------------------------
 ...
 * This class deals exclusively with Distributed Mailboxes when using the Discovery 
 * functionality.
 * <p>
...
class MessageTestRemote
{
   public:
      ...
      /** Constructor */
      MessageTestRemote(string& localMailboxName, int localPortNumber);
      ...
      MailboxAddress& getLocalMailboxAddress();
   ...
   private:
      ...
      /** Local Mailbox Address (MailboxName and Port are supplied by the user/caller) */
