...
echo "Starting the ClientAgent..."

./ClientAgent -h -i "NameService=corbaloc:iiop:127.0.0.1:1050/NameService" -e "iiop://127.0.0.1:1070" -d -l 10 -f "/tmp/platformclientagent.out"
